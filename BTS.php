...
<div id="wrapper">
    ...
    <nav id="menu">
        ...
        <ul>
            ...
            <li><a href="BTS.php" class="active">BTS</a></li>
    ...
    <div id="main">
        <div class="inner">
            <h1>Le BTS SIO SLAM, c'est quoi ?</h1>

            <div class="image main">
                <img src="images/Article-Rayan-Morgan-4-scaled.jpg" class="img-fluid" alt=""/>
            </div>

            <p>Le Brevet de Technicien Supérieur - Services Informatiques aux Organisations (BTS SIO), s'adresse à ceux
                qui souhaitent se former en deux ans aux métiers d'administrateur réseau ou de développeur. Pour par la
                suite intégré directement le marché du travail ou continuer des études, dans le domaine de
                l'informatique.</p>

            <h2>Les options du BTS :</h2>
            <div class="OPTION">
                <div class="SISR">

                    <u>OPTION A : SOLUTIONS D'INFRASTRUCTURE, SYSTEMES ET RESEAUX</u>
                    <br>
                    La spécialisation SISR forme des professionnels des réseaux et équipements informatiques
                    (installation, maintenance, sécurité). Cela signifie intervenir sur la conception, la mise en place,
                    le déploiement, la maintenance et le maintien de sa sécurité.
                </div>
				<div class="SLAM">
					<u>OPTION B: SOLUTIONS LOGICIELLES ET APPLICATIONS METIERS</u>
                    <br>
